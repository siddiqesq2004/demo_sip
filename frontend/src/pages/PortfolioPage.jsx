  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-24 text-[#101828]">
      ...
      <div className="px-4 mt-6 space-y-6">
        {/* Hero Card */}
        <div className="bg-[#0B3B2F] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-extrabold mb-4">{formatCurrency(portfolio?.total_value || 125430)}</h2>
