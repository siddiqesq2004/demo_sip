...
export default function PaymentModal({
  ...
  return createPortal(
    ...
    >
      <div className="bg-white w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl border border-gray-100 max-h-full flex flex-col overflow-y-auto scrollbar-hide">
        {/* Header */}
